...
$dadosboleto["nosso_numero1"] = isset($nosso_numero) ? $nosso_numero : "87654"; // tamanho 3
$dadosboleto["nosso_numero_const1"] = "2"; //constanto 1 , 1=registrada , 2=sem registro

$dadosboleto["nosso_numero2"] = isset($nosso_numero) ? $nosso_numero : "87654"; // tamanho 3
$dadosboleto["nosso_numero_const2"] = "4"; //constanto 2 , 4=emitido pelo proprio cliente

$dadosboleto["nosso_numero3"] = ""; // tamanho 9
...
$dadosboleto["conta_cedente"] 			= isset($conta) ? $conta[0] : ""; // ContaCedente do Cliente, sem digito (Somente Números)
$dadosboleto["conta_cedente_dv"] 		= isset($conta) ? $conta[1] : "3"; // Digito da ContaCedente do Cliente
$dadosboleto["carteira"]                = isset($carteira) ? $carteira : "SR";  // Código da Carteira: pode ser SR (Sem Registro) ou CR (Com Registro) - (Confirmar com gerente qual usar)
