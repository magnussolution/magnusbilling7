...
$dadosboleto["numero_documento"] = isset($nosso_numero) ? $nosso_numero : "87654";// Número do documento - REGRA: Máximo de 13 digitos
...
$dadosboleto["codigo_cedente"] = isset($convenio) ? $convenio[0] : "7777777";// Código do Cedente (Somente 7 digitos)
$dadosboleto["carteira"] = isset($carteira) ? $carteira : "CNR";  // Código da Carteira
