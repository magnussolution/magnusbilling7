...
$dadosboleto["convenio"]                = isset($convenio) ? $convenio[0] : "7777777";  // Num do convênio - REGRA: 6 ou 7 ou 8 dígitos
$dadosboleto["contrato"]                = isset($especie_doc) ? $instrucoes1 : "999999"; // Num do seu contrato
$dadosboleto["carteira"]                = isset($carteira) ? $carteira : "18";
$dadosboleto["variacao_carteira"]       = isset($variacao_carteira) ? $variacao_carteira : "-019";  // Variação da Carteira, com traço (opcional)
