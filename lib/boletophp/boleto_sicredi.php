...
$dadosboleto["nosso_numero"]        = isset($nosso_numero) ? $nosso_numero : "87654";  			// Nosso numero (máx. 5 digitos) - Numero sequencial de controle.
...
$dadosboleto["aceite"]                  = isset($aceite) ? $aceite :"N";
$dadosboleto["especie"]                 = isset($especie) ? $especie :"R$";
$dadosboleto["especie_doc"]             = isset($especie_doc) ? $especie_doc :"A";
