...
$dadosboleto["data_documento"]      = isset($data_documento) ? $data_documento : date("d/m/Y");    // Data de processamento do boleto (opcional)
$dadosboleto["data_processamento"]  = isset($data_documento) ? $data_documento : date("d/m/Y");    // Data de processamento do boleto (opcional)
