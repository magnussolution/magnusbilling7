...
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width=160 class=cp><img src="../../../lib/boletophp/imagens/logosudameris.jpg" alt="Sudameris" width="150" height="27"></td>
		<td width=3 valign=bottom><img height=22 src=../../../lib/boletophp/imagens/3.png width=2></td>
	...
	<tr><td colspan=5><img height=1 src=../../../lib/boletophp/imagens/2.png width=666></td></tr>
</table>
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width=7 height=1><img src=../../../lib/boletophp/imagens/1.png width=7 height=1></td>
		<td width=112><img src=../../../lib/boletophp/imagens/1.png width=112 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/1.png width=7 height=1></td>
		<td width=113><img src=../../../lib/boletophp/imagens/1.png width=113 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/1.png width=7 height=1></td>
		<td width=53><img src=../../../lib/boletophp/imagens/1.png width=53 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/1.png width=7 height=1></td>
		<td width=53><img src=../../../lib/boletophp/imagens/1.png width=53 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/1.png width=7 height=1></td>
		<td width=113><img src=../../../lib/boletophp/imagens/1.png width=113 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/1.png width=7 height=1></td>
		<td width=180><img src=../../../lib/boletophp/imagens/1.png width=180 height=1></td>
	</tr>
	<tr>
		<td height=13><img src=../../../lib/boletophp/imagens/1.png width=1 height=13></td>
		<td colspan=7 class=ct>Cedente</td>
		<td><img src=../../../lib/boletophp/imagens/1.png width=1 height=13></td>
		<td class=ct>Agência/Código do Cedente</td>
		<td><img src=../../../lib/boletophp/imagens/1.png width=1 height=13></td>
		<td class=ct>Vencimento</td>
	</tr>
	<tr>
		<td height=12><img src=../../../lib/boletophp/imagens/1.png width=1 height=12></td>
		<td colspan=7 class=cp><?php echo $dadosboleto["cedente"]?></td>
		<td><img src=../../../lib/boletophp/imagens/1.png width=1 height=12></td>
		<td class=cp><?php echo $dadosboleto["agencia_codigo"]?></td>
		<td><img src=../../../lib/boletophp/imagens/1.png width=1 height=12></td>
		<td class=cp align=right><?php echo $dadosboleto["data_vencimento"]?></td>
	</tr>
	<tr><td colspan=12 height=1><img src=../../../lib/boletophp/imagens/2.png width=666 height=1></td></tr>
	<tr>
		<td height=13><img src=../../../lib/boletophp/imagens/1.png width=1 height=13></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	...
	<tr><td colspan=4><img src=../../../lib/boletophp/imagens/6.png width=665 height=1></td></tr>
</table>
&nbsp;<br>
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
...
<table cellspacing=0 cellpadding=0 border=0 height="2">
	<tr>
		<td width=7 height=1><img src=../../../lib/boletophp/imagens/2.png width=7 height=1></td>
		<td width=100><img src=../../../lib/boletophp/imagens/2.png width=100 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/2.png width=7 height=1></td>
		<td width=74><img src=../../../lib/boletophp/imagens/2.png width=74 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/2.png width=7 height=1></td>
		<td width=73><img src=../../../lib/boletophp/imagens/2.png width=73 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/2.png width=7 height=1></td>
		<td width=55><img src=../../../lib/boletophp/imagens/2.png width=55 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/2.png width=7 height=1></td>
		<td width=35><img src=../../../lib/boletophp/imagens/2.png width=35 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/2.png width=7 height=1></td>
		<td width=100><img src=../../../lib/boletophp/imagens/2.png width=100 height=1></td>
		<td width=7><img src=../../../lib/boletophp/imagens/2.png width=7 height=1></td>
		<td width=180><img src=../../../lib/boletophp/imagens/2.png width=180 height=1></td>
	</tr>
	<tr>
		<td height=13><img src=../../../lib/boletophp/imagens/1.png width=1 height=13></td>
	...
	<tr><td colspan=14 height=1><img src=../../../lib/boletophp/imagens/2.png width=666 height=1></td></tr>
	<tr>
		<td height=13><img src=../../../lib/boletophp/imagens/1.png width=1 height=13></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width=7 height=26><img src=../../../lib/boletophp/imagens/1.png width=1 height=26></td>
		...
		<td width=7><img src=../../../lib/boletophp/imagens/2.png width=1 height=26></td>
		<td width=180 class=ct>(-) Desconto / Abatimentos</td>
	</tr>
	<tr><td height=1><img src=../../../lib/boletophp/imagens/2.png width=1 height=1></td><td><img src=../../../lib/boletophp/imagens/2.png width=7 height=1></td><td><img src=../../../lib/boletophp/imagens/2.png width=180 height=1></td></tr>
	<tr>
		<td height=26><img src=../../../lib/boletophp/imagens/1.png width=1 height=26></td>
		<td><img src=../../../lib/boletophp/imagens/2.png width=1 height=26></td>
		<td class=ct>(-) Outras deduções</td>
	</tr>
	<tr><td height=1><img src=../../../lib/boletophp/imagens/1.png width=1 height=1></td><td><img src=../../../lib/boletophp/imagens/2.png width=7 height=1></td><td><img src=../../../lib/boletophp/imagens/2.png width=180 height=1></td></tr>
	<tr>
		<td height=26><img src=../../../lib/boletophp/imagens/1.png width=1 height=26></td>
		<td><img src=../../../lib/boletophp/imagens/2.png width=1 height=26></td>
	...
	<tr><td colspan=4 height=1><img src=../../../lib/boletophp/imagens/2.png width=666 height=1></td></tr>
	<tr>
		<td height=13><img src=../../../lib/boletophp/imagens/1.png width=1 height=13></td>
		<td class=ct>Sacado</td>
		<td><img src=../../../lib/boletophp/imagens/b.png width=1 height=1></td>
		<td><img src=../../../lib/boletophp/imagens/b.png width=1 height=1></td>
	</tr>
	<tr>
		<td height=39><img src=../../../lib/boletophp/imagens/1.png width=1 height=39></td>
		<td class=cp><?php echo $dadosboleto["sacado"] . '<br>' . $dadosboleto["endereco1"] . '<br>' . $dadosboleto["endereco2"]?></td>
		<td valign=bottom><img src=../../../lib/boletophp/imagens/1.png width=1 height=13></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	...
	<tr><td colspan=2 height=1><img src=../../../lib/boletophp/imagens/6.png width=665 height=1></td></tr>
</table>
</body>
