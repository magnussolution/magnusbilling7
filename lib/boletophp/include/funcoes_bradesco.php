...
$nnum = formata_numero($dadosboleto["carteira"],2,0).formata_numero($dadosboleto["numero_documento"],11,0);
//dv do nosso número
...
//Guarda inicial
?><img src=../../../lib/boletophp/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../../../lib/boletophp/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../../../lib/boletophp/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../../../lib/boletophp/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=../../../lib/boletophp/imagens/p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=../../../lib/boletophp/imagens/b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=../../../lib/boletophp/imagens/p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=../../../lib/boletophp/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../../../lib/boletophp/imagens/p.png width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da função
