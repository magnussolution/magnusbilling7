...
class CallSummaryMonthAgentController extends Controller
{
    ...
    {
        $this->instanceModel = new CallSummaryMonthAgent;
        $this->abstractModel = CallSummaryMonthAgent::model();
        $this->titleReport   = Yii::t('yii', 'Calls Summary per Month per agent');
        parent::init();
    }
