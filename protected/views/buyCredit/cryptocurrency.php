...
<?php
    ...
    if (isset($_SESSION[$crypto]) && $_SESSION[$crypto] == $_GET['amount'] && isset($_SESSION['modelCryptocurrency_id'])) {
        ...
        $modelCryptocurrency = Cryptocurrency::model()->find(
            'id = :key AND status = 0',
        ...
        for (;;) {
            $modelCryptocurrency = Cryptocurrency::model()->find(
                'amountCrypto = :key AND date > :key1',
            ...
            <tr>
                <td class="banco">
                    <table width="100%" border="0">
                        ...
                        <tr>
                            <td width="350">
                                <p style="text-align: right;"><b>Address:&nbsp;</b></p>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td width="350">
                                <p style="text-align: right;"><b><?php echo strtoupper($MB_currency) ?> Credit: &nbsp;</b></p>
                            </td>
                            <td width="400">
                                <p style="text-align: left;"><?php echo strtoupper($MB_currency) ?> <?php echo number_format($_GET['amount'], 2) ?></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="350">
                                <p style="text-align: right;"><b>Crypto amount: &nbsp;</b></p>
                            </td>
                            <td width="400">
                                <p style="text-align: left;">
                                    <font color=red><?php echo $crypto ?> <?php echo $amountCrypto ?></font>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td width="350">
                                <p style="text-align: right;"><b>Crypto Network: &nbsp;</b></p>
                            </td>
                            <td width="400">
                                <p style="text-align: left;"><?php echo $network ?> </p>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
