 ...
 * 01/10/2013
 */
Ext.define('MBilling.view.callSummaryPerTrunk.Controller', {
    extend: 'Ext.ux.app.ViewController',
    alias: 'controller.callsummarypertrunk',
    formHidden: true,
    onEdit: function() {
        me = this;
    ...
    onExportCsvUser: function(grid, rowIndex, colIndex) {
        ...
        window.open('index.php/callSummaryPerTrunk/exportCsvCalls?id=' + grid.getStore().getAt(rowIndex).getData().idTrunktrunkcode + '&filter=' + filter);
    }
});